...
export default function PassengerDashboard() {
  ...
  // Rating states - CORRIGIDO PARA PREVENIR LOOP
  ...
  // FUNÇÃO CORRIGIDA PARA PREVENIR LOOP DE AVALIAÇÃO
  ...
  // FUNÇÃO CORRIGIDA PARA PREVENIR LOOP
  ...
  const submitRating = async () => {
    ...
    try {
      ...
      // Close modal immediately to prevent re-opening
      setShowRatingModal(false);
      ...
      // Even if submission fails, keep trip marked as rated and modal closed to prevent loop
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* Rating Modal CORRIGIDO PARA PREVENIR LOOP */}
