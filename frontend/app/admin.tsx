...
export default function AdminApp() {
  ...
  const handleRegister = () => {
    router.push('/auth/register?mode=admin');
  };
      ...
      {!currentUser ? (
        <View style={styles.authContainer}>
          <View style={styles.appCard}>
            <Ionicons name="settings" size={80} color="#FF9800" />
            <Text style={styles.appTitle}>Painel Administrativo</Text>
            <Text style={styles.appDescription}>
              Gerencie usuários, motoristas, viagens e monitore as operações do sistema
            </Text>
            ...
            <View style={styles.buttonContainer}>
              ...
              <TouchableOpacity style={styles.registerButton} onPress={handleRegister}>
                <Text style={styles.registerButtonText}>Criar Conta Admin</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
