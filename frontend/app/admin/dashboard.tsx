                  ...
                  <View style={styles.chatUser}>
                    ...
                    <View>
                      <TouchableOpacity
                        onPress={() => {
                          setActiveTab('users');
                          setHighlightedUserId(item.driver.id);
                          // Clear highlight after 3 seconds
                          setTimeout(() => setHighlightedUserId(''), 3000);
                        }}
                      >
    ...
    <SafeAreaView style={styles.container}>
      ...
      {isAdminFull && (
        <View style={styles.adminFullControls}>
          <View style={styles.adminFullHeader}>
            <Ionicons name="star" size={20} color="#FFD700" />
            <Text style={styles.adminFullControlsTitle}>Controles de Admin Full</Text>
          </View>
          
          {/* Create Users Section */}
          <View style={styles.adminFullSection}>
            <Text style={styles.adminFullSectionTitle}>Criar Usuários</Text>
            <View style={styles.adminFullButtonsGrid}>
              <TouchableOpacity
                style={[styles.adminFullControlButton, styles.createAdminButton]}
                onPress={() => {
              ...
              >
                ...
                <Text style={styles.adminFullControlButtonText}>Criar</Text>
                <Text style={styles.adminFullControlButtonSubtext}>Administrador</Text>
              </TouchableOpacity>
              
              <TouchableOpacity
                style={[styles.adminFullControlButton, styles.createManagerButton]}
                onPress={() => {
              ...
              >
                ...
                <Text style={styles.adminFullControlButtonText}>Criar</Text>
                <Text style={styles.adminFullControlButtonSubtext}>Gerência</Text>
                <Text style={styles.buttonBadge}>{managers.length}/4</Text>
              </TouchableOpacity>
              
              <TouchableOpacity
                style={[styles.adminFullControlButton, styles.createSupportButton]}
                onPress={() => {
              ...
              >
                ...
                <Text style={styles.adminFullControlButtonText}>Criar</Text>
                <Text style={styles.adminFullControlButtonSubtext}>Colaborador</Text>
                <Text style={styles.buttonBadge}>{supportCollaborators.length}/30</Text>
              </TouchableOpacity>
            </View>
          </View>
          ...
          {/* Transfer Section */}
          <View style={styles.adminFullSection}>
            <Text style={styles.adminFullSectionTitle}>Administração</Text>
            <TouchableOpacity
            ...
            >
              ...
              <Text style={styles.adminFullControlButtonText}>Transferir</Text>
              <Text style={styles.adminFullControlButtonSubtext}>Admin Full</Text>
            </TouchableOpacity>
          </View>
        </View>
      )}
...
const styles = StyleSheet.create({
  ...
  adminFullAlertMessage: {
    fontSize: 14,
    color: '#888',
    lineHeight: 20,
  },
  createAdminFullButton: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#FF9800',
    paddingHorizontal: 12,
  ...
  createAdminFullButtonText: {
    color: '#fff',
    fontSize: 12,
    fontWeight: 'bold',
  },
  // Create Admin Full Modal Styles
  createAdminFullModalContent: {
    backgroundColor: '#2a2a2a',
    borderRadius: 16,
    padding: 24,
    width: '90%',
  ...
  createAdminFullModalHeader: {
    alignItems: 'center',
    marginBottom: 24,
  },
  createAdminFullModalTitle: {
    fontSize: 20,
    fontWeight: 'bold',
    color: '#fff',
    marginTop: 8,
  },
  createAdminFullModalBody: {
    marginBottom: 24,
  },
  createAdminFullModalText: {
    fontSize: 16,
    color: '#fff',
    textAlign: 'center',
    marginBottom: 20,
  ...
  createAdminFullModalActions: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    gap: 12,
  },
  cancelAdminFullButton: {
    flex: 1,
    backgroundColor: '#666',
    paddingVertical: 12,
    borderRadius: 8,
  ...
  cancelAdminFullButtonText: {
    color: '#fff',
    fontSize: 16,
    fontWeight: 'bold',
  },
  confirmAdminFullButton: {
    flex: 1,
    flexDirection: 'row',
    backgroundColor: '#FF9800',
    paddingVertical: 12,
  ...
  confirmAdminFullButtonText: {
    color: '#fff',
    fontSize: 16,
    fontWeight: 'bold',
  },
  // Enhanced Admin Full Controls Styles
  adminFullControls: {
    backgroundColor: '#2a2a2a',
    margin: 16,
    borderRadius: 16,
  ...
  adminFullButtonsGrid: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    justifyContent: 'space-between',
    gap: 12,
  },
  adminFullControlButton: {
  ...
  adminFullControlButtonText: {
    color: '#fff',
    fontSize: 12,
    fontWeight: 'bold',
    textAlign: 'center',
  },
  adminFullControlButtonSubtext: {
    color: '#fff',
    fontSize: 11,
    textAlign: 'center',
    opacity: 0.9,
  ...
  createUserSubmitButtonText: {
    color: '#fff',
    fontSize: 16,
    fontWeight: 'bold',
  },
  // Transfer Admin Full Modal Styles
